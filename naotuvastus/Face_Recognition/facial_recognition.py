...
# Salvesta tuvastatud nimed faili
if face_names:
    with open("detected_names.txt", "w", encoding="utf-8") as f:
        for name in face_names:
            f.write(f"{name}\n")
    print(f"[INFO] Tuvastatud nimed salvestatud detected_names.txt faili: {face_names}")
else:
