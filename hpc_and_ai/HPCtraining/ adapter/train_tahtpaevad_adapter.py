...
if __name__ == "__main__":
    train_domain_adapter(
        ...
        output_adapter_dir="adapters1.1/tahtpaevad",
        checkpoint_dir="checkpoints1.1/tahtpaevad",
        domain_name="tahtpaevad",
        system_msg="Sa oled abivalmis assistent. Vasta lühidalt ja eesti keeles. Teema on tähtpäevad.",
    )
